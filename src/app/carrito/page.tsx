...
import { CartIcon, BoxIcon, TrashIcon, ChevronLeftIcon, PinIcon, CheckIcon, CreditCardIcon, LockIcon } from '@/components/icons/Icons'
    ...
    return (
      <div className="min-h-screen bg-white pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            <BoxIcon className="w-5 h-5" /> Volver al catálogo
          </Link>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        <h1 className="flex items-center gap-3 text-4xl font-bold text-gray-900 mb-8">
          <CartIcon className="w-9 h-9" /> Tu Carrito
        </h1>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                      ...
                      <tr key={item.codigo} className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 text-red-600 hover:text-red-700 font-semibold transition"
                          >
              ...
              <div className="p-6 bg-gray-50 border-t-2 border-gray-200 flex justify-between">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-red-600 hover:text-red-700 font-bold transition"
                >
                  <TrashIcon className="w-4 h-4" /> Limpiar carrito
                </button>
                <Link
                  href="/catalogo"
                  className="inline-flex items-center gap-1.5 text-blue-600 hover:text-blue-700 font-bold transition"
                >
                  <ChevronLeftIcon className="w-4 h-4" /> Seguir comprando
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-24">
              ...
              <div className="mb-6 pb-6 border-b border-gray-200">
                <p className="text-sm text-gray-600 mb-2 flex items-start gap-1.5">
                  <PinIcon className="w-4 h-4 mt-0.5 flex-shrink-0" /> <span><strong>Envío:</strong> a todo Uruguay</span>
                </p>
                <p className="text-sm text-green-600 font-semibold flex items-center gap-1.5">
                  <CheckIcon className="w-4 h-4 flex-shrink-0" /> Envío GRATIS (en compras mayores a ${siteConfig.shipping.minOrderForFreeShipping.toLocaleString('es-UY')})
                </p>
              </div>
              ...
              <div className="space-y-3">
                <Link
                  href="/checkout"
                  className="flex items-center justify-center gap-2 w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-4 rounded-lg text-center transition transform hover:scale-105 shadow-lg"
                >
                  <CreditCardIcon className="w-5 h-5" /> Ir a Pagar
                </Link>
                <button
                  onClick={() => router.push('/')}
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-xs text-gray-600 text-center flex items-center justify-center gap-1.5">
                  <LockIcon className="w-3.5 h-3.5" /> Compra 100% segura con Mercado Pago
                </p>
                <p className="text-xs text-gray-600 text-center mt-2 flex items-center justify-center gap-1.5">
                  <CheckIcon className="w-3.5 h-3.5" /> Hasta 12 cuotas sin interés
                </p>
              </div>
            </div>
          </div>
